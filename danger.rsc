...
:global scriptBlckr;            # Flag of the running script.
        ...
        :if ([:len [/interface list find name=$inIfaceList]]!=0) do={
            ...
            :if ($firewallUsage) do={
                ...
                :local firewallFilterRules [:toarray {
                    ...
                    "add action=tarpit chain=TARPIT comment=\"Slow down attack to router\" limit=10,5:packet protocol=tcp";
                    ...
                    "add action=add-src-to-address-list chain=input comment=\"Add to BlackList attacker who used unopened ports\" address-list=$nameBlackList address-list-timeout=$timeoutBL dst-address-type=unicast in-interface-list=$inIfaceList";
